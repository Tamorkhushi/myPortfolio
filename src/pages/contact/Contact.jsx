                        ...
                        <div className="h-auto w-[28rem] flex flex-col items-center bg-white/5 backdrop-blur-lg py-2 ">
                            ...
                            <form className="mt-1 sm:mt-2  md:mt-4 lg:mt-6 xl:mt-7 w-auto p-4 rounded-lg">
                                ...
                                <textarea
                                    ...
                                    className="bg-transparent text-white border-[1px] h-32 sm:h-40 md:h-48 lg:56 xl:h-64 w-full text-[14px] sm:text-[16px] md:text-[18px] lg:text-lg xl:text-lg rounded-sm sm:rounded-sm md:rounded-md lg:rounded-lg xl:rounded-lg pl-[4px] sm:pl-2 md:pl-3 lg:pl-4 xl:pl-4 mb-2 sm:mb-4"
                                ></textarea>
                                <button className=" border-[1px]  h-[2rem] sm:h-[2.5rem] md:h-[2.7rem] lg:h-[3.2rem] xl:h-[3.5rem] w-full sm:text-[18px] md:text-[20px] lg:text-lg xl:text-lg rounded-sm sm:rounded-sm md:rounded-md lg:rounded-lg xl:rounded-lg pl-4 outline-none font-bold bg-blue-500 uppercase text-white">send message</button>
                            </form>
                        </div>
